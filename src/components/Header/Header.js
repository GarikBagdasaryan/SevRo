        ...
        <header className="Header-slice ">
            <div className="Header-slice__sticky container">
                <div className="Header-slice__headerLogo">
                    <Link to="/"> <img width={50} height={50} src="img/logo-rso.png"></img></Link>
                    <Link to="/"> <img width={50} height={50} src="img/logo-sevro.png"></img></Link>
                </div>
                ...
                <div className='Header-slice__burger'>
                    ...
                    {isOpen ? <button onClick={handleMenu} className='Header-slice__burger__button'>
                    ...
                    </button> : <button onClick={handleMenu} className='Header-slice__burger__button'>
                        <svg width="50" height="36" viewBox="0 0 50 36" fill="none" className='Header-slice__burger__button' onClick={ActionMenu}  >
                            <rect id="bar1" width="50" height="4" rx="2" fill="#F7F7F7" />
                            <rect id="bar2" y="16" width="50" height="4" rx="2" fill="#F7F7F7" />
                            <rect id="bar3" y="32" width="50" height="4" rx="2" fill="#F7F7F7" />
                    ...
                    <div className="Header-slice__burger-modal container" style={hideOrShow}>
                        <div className="Header-slice__burger-modal-items">
                            ...
                            <div className="Header-slice__burger-modal__headerButton">
                                <button className="Header-slice__burger-modal__headerButton__button">Вступить</button>
                            </div>
