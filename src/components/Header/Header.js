						...
						<div className="Header__burger-modal-items">
							...
							<div className="Header__burger-modal__headerLinks">
								<ul>
									...
									<li>
										<Link to="/news" onClick={handleLink}>
											новости
										</Link>
									</li>
									<li>
										<Link to="/gallery" onClick={handleLink}>
											галерея
										</Link>
									</li>
									<li>
										<Link to="/fighters" onClick={handleLink}>
											бойцам
										</Link>
									</li>
									<li>
										<Link to="/#form" onClick={handleLink}>
											сотрудничество
										</Link>
									</li>
									<li>
										<Link to="/#question" onClick={handleLink}>
											Q&A
										</Link>
									</li>
								</ul>
							...
							<div className="Header__burger-modal__headerButton">
								<button className="Header__burger-modal__headerButton__button">Вступить</button>
							</div>
